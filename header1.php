...
<head>
    ...
    <link rel="stylesheet" href="shopline.css?v=<?php echo time(); ?>">
</head>
<body>
    <nav class="navbar navbar-expand-lg bg-light top-nav border-bottom border-primary border-3">
        ...
        <button type="button" class="btn text-dark modal1" data-bs-toggle="modal" data-bs-target="#exampleModal">
          ...
          <div class="btn-group btn-1" role="group">
              ...
              ?>
              <a href="login.php" class="btn btn-primary sub-btn-1"><i class="fas fa-cart-arrow-down"></i> Chart</a>
              ...
              ?>
              <a href="shopping-cart.php" class="btn btn-primary sub-btn-1"><i class="fas fa-cart-arrow-down"></i> Chart</a>
          ...
          <div class="modal-body">
              ...
              <?php
                ...
                <div class="row justify-content-center">
                  <a href="login.php" class="btn btn-primary sub-btn-1"><i class="fas fa-cart-plus"></i> Chart</a>
                </div>
                <div class="row justify-content-center">
                  <a href="signup.php" class="btn btn-primary sub-btn-1"><i class="fas fa-user-plus"></i> Sign-up</a>
                </div>
                ...
                ?>
                <div class="row justify-content-center">
                  <a href="shopping-cart.php" class="btn btn-primary sub-btn-1"><i class="fas fa-cart-plus"></i> Chart</a>
                </div>
                <div class="row justify-content-center">
                  <a href="profile.php" class="btn btn-primary sub-btn-1"><i class="fas fa-user-circle"></i> Profile</a>
                </div>
